  ...
  <div class="flex relative z-20 items-center">
    ...
    >
      <div class="flex flex-col">
        <img src="~/assets/foto.jpg" class="rounded-full w-64 mx-auto" />
        <h2
        ...
        <div class="flex items-center justify-center mt-4">
          <a
            href="mailto:arielrnr1995@gmail.com"
        ...
        <span class="text-gray-800 text-xs"> arielrnr1995@gmail.com </span>
      </div>
      <div
        class="pt-8 flex border-t border-gray-200 w-44 mx-auto text-gray-500 items-center justify-between"
      >
        <a href="https://twitter.com/Arielt1995">
          <svg
            width="30"
            height="30"
            fill="currentColor"
        ...
        <a href="https://github.com/ariel1995cr">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
        ...
        <a
          href="https://www.linkedin.com/in/sergio-ariel-trivi%C3%B1o-39145a9b/"
        >
          <svg
            width="30"
            height="30"
